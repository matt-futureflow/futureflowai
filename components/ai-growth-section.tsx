    ...
    <section className="bg-white py-20 px-4 relative">
      ...
      <div className="max-w-6xl mx-auto  relative z-10">
        ...
        <div className="grid lg:grid-cols-3 space-y-7 sm:space-y-0 gap-8">
          {pillars.map((pillar) => (
            <div key={pillar.number} className="bg-white rounded-2xl p-8 border border-purple-200 shadow-lg relative">
              ...
              <div className="pt-8">
                ...
                <div className="space-y-4">
                  {pillar.features.map((feature, index) => (
                    <div key={index} className="bg-purple-50 rounded-xl p-4 flex items-start gap-3">
