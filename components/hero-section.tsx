  ...
  return (
    <div className="relative pt-10 bg-gradient-to-r from-[#003B20] to-black overflow-hidden">
      ...
      <div className=" text-center px-4 pt-16 ">
        <h2 className="text-xl text-[#00FF9D] tracking-wide md:text-2xl ">
          For Service Based Businesses Generating 50+ Leads Per Month
        </h2>

        <h2 className=" text-4xl mt-6 max-w-5xl mx-auto text-white font-bold tracking-wide md:text-6xl ">
          Never Waste A Lead With Our <br />{" "}
          <span className="text-[#00FF9D]">AI Growth System</span>
        </h2>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-3xl md:text-4xl  text-white font-semibold leading-relaxed">
                Capture, Qualify, And Convert More {" "}
                <span className="text-[#00FF9D]">Leads With AI</span>
              </h1>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-white text-lg lg:text-xl">
                  ...
                  <span className="text-[#00FF9D]">Consistent</span> Lead
                  Activation.
                </p>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <p className="text-white text-lg lg:text-xl">
                  Spend More Time{" "}
                  <span className="text-[#00FF9D]">Selling</span>, Less Time
                  Chasing
                </p>
              </div>
            </div>
